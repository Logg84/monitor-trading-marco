...
.mg-body b, .mg-body strong { color: var(--txt-1); font-weight: 600; }
...
.mg-table tbody tr:nth-child(even) td { background: var(--bg-hover); }
.mg-table tbody tr:hover td { background: var(--bg-hover); }
.mg-table .score {
    font-family: 'IBM Plex Mono', monospace;
    font-weight: 700;
    text-align: center;
...
.mg-disclaimer b { color: var(--warn-strong); }
